...
namespace MoreMountains.TopDownEngine
{
	...
	public class Character : TopDownMonoBehaviour
	{
		...
		{            
            ...
            //Original Removed to set new parent to aiming direction
            CameraTarget.transform.SetParent(this.transform);
            //Original Removed line
            CameraTarget.transform.localPosition = Vector3.zero;

            //CameraTarget.transform.SetParent(transform.Find("AimDirectionMarkerContainer"));

            //Added to move the target infront of the Aim direction
			//CameraTarget.transform.localPosition = new Vector3(0, 0, 2.4f);
